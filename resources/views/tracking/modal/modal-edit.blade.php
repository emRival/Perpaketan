{{-- Modal tambah santri  --}}
<div class="modal fade" id="editbarang{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form method="POST" action="{{route('satpam.update', $row->id)}}" role="form" enctype="multipart/form-data">
				@csrf
				@method('PUT')
				...
				<div class="modal-body" style="text-align: left !important;">
					...
					<div class="form-group">
						...
						<input type="text" required class="form-control" value="{{$row->nama_barang}}" name="nama_barang">
					</div>
					<div class="container">
						<div class="row">
							<div class="form-group col-md-6">
								<label>Ekspedisi</label>
								<input type="text" required class="form-control" value="{{$row->ekspedisi}}" name="ekspedisi">
							</div>
							<div class="form-group col-md-6">
								<label>Status</label>
