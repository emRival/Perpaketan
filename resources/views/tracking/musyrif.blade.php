						...
						<div class="table-responsive">
							<div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
								<div class="row">
									...
									<div class="col-sm-12 col-md-6">
										<form class="form" method="get" action="{{route('cari.musyrif')}}">
												...
												<tr role="row" class="odd text-center">
													...
													<td>
														<div class="form-button-action">
															@if(Auth::user()->role == 'Admin' || Auth::user()->role == 'Musyrif')
															<a data-target="#editbarangmusyrif{{$row->id}}" data-toggle="modal" data-id="row->id" data-nama_kategori="row->nama_kategori" title="Edit" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
